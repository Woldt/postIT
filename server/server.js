...
app.use(function(req, res, next) {
  var allowedOrigins = ['http://it2810-02.idi.ntnu.no:8080','http://localhost:5000', 'http://localhost:3000','http://www.postit.idi.ntnu.no:5000','http://www.it2810-02.idi.ntnu.no:5000'];  // Allow client server/domain to send requests
